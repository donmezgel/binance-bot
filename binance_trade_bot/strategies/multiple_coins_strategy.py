    ...
    def scout(self):
        ...
        for coin in self.db.get_coins():
            ...
            if coin_price is None:
                self.logger.info("Keşif modu pas geçiliyor... mevcut coin {} bulunamadı".format(coin + self.config.BRIDGE))
                continue
            ...
            print(
                f"{datetime.now()} - CONSOLE - INFO - En uygun alım-satım fırsatlarına bakıyorum.. "
